...
const introductionImage = "Entrance Image.jpg"

const scenePairs = [
    {
        escape: `“I sense carnage. I see—an operating theatre. 𝑌𝑒𝑠. When the Sun sleeps in the House of the Mountain, you will file into the operating theatre and take your seat. In the stands, you will look down at a man in a bloodstained lab coat. 𝑇ℎ𝑒 ℎ𝑢𝑚𝑎𝑛 ℎ𝑒𝑎𝑟𝑡, Dr. Bellweather prosects, 𝑠𝑖𝑛𝑔𝑠 𝑙𝑖𝑓𝑒 𝑡ℎ𝑟𝑜𝑢𝑔ℎ 𝑜𝑢𝑟 𝑣𝑒𝑖𝑛𝑠, 𝑎𝑛𝑑 ℎ𝑒𝑙𝑝𝑠 𝑢𝑠 𝑡𝑜 𝑏𝑒𝑎𝑟 𝑡ℎ𝑒 𝑠𝑡𝑟𝑒𝑠𝑠 𝑜𝑓 𝑏𝑙𝑜𝑜𝑑’𝑠 𝑑𝑒𝑚𝑎𝑛𝑑𝑠. 𝐴𝑛𝑑 𝑦𝑒𝑡! 𝐿𝑖𝑘𝑒 𝑐𝑙𝑜𝑐𝑘𝑤𝑜𝑟𝑘, ℎ𝑜𝑤 𝑞𝑢𝑖𝑐𝑘𝑙𝑦,ℎ𝑜𝑤 𝑝𝑟𝑒𝑑𝑖𝑐𝑡𝑎𝑏𝑙𝑦, 𝑖𝑡 𝑤𝑒𝑎𝑟𝑠 𝑜𝑢𝑡 𝑜𝑣𝑒𝑟 𝑡𝑖𝑚𝑒. Between them, a terrified man, his flushed-drink face, his hideous lime-raw knuckles… 
        ...
        penance: `“I see… you, stumbling through the rivulose halls of the Penrose Library for the Pursuit of the Invisible Sciences. 
